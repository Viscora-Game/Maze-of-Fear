import { generateMaze } from "./maze.js?v=1003";
import { AudioEngine } from "./audio.js?v=1003";
import { CanvasRenderer } from "./canvas.js?v=1003";
import { translations } from "./translations.js?v=1003";
import { randomEvents, deathEvents } from "./events.js?v=1003";
import { getSeededRandom } from "./prng.js?v=1003";
...
export class Game {
  constructor() {
    ...
    this.characterSkin = localStorage.getItem("selected_character_skin") || "ghost";
    this.unlockedSkins = ["ghost", "vampire", "zombie", "skeleton", "ghoul", "traveler"];
