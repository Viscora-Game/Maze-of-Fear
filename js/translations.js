export const translations = {
  en: {
    ...
    play: "Play",
    characterSelect: "🎭 Character Selection (Skin)",
    settings: "Settings",
    ...
    achGroupCoop: "Co-op Mode Achievements (Co-op)",
  ...
  tr: {
    ...
    play: "Oyna",
    characterSelect: "🎭 Karakter Seçimi (Skin)",
    settings: "Ayarlar",
    ...
    achGroupHard: "Zor Mod Başarımları (Hard)",
    achGroupNightmare: "Kabus Mod Başarımları (Nightmare)",
    achGroupCoop: "Co-op Modu Başarımları (Co-op)",
    achGroupGeneral: "Genel Başarımlar (General)",
